...
def get_image_size():
	img = cv2.imread('gestures/0/100.jpg', 0)   #Reading image size from gestures O label 100th image
	return img.shape
...
full_img = None
for i in range(rows):                                                          #here logic is to display staced images in rows calculated above with 
                                                                               #max of 5 columns
	col_img = None
